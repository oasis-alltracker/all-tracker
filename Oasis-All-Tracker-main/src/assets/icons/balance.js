...
function SvgComponent(props) {
  return (
    ...
    >
      ...
      />
      <Path
        d="M12 18.75c-4.13 0-7.25-2.62-7.25-6.1v-5c0-3.53 3.25-6.4 7.25-6.4 1.92 0 3.72.65 5.09 1.83 1.39 1.23 2.16 2.85 2.16 4.57v5c0 3.48-3.12 6.1-7.25 6.1zm0-16c-3.17 0-5.75 2.2-5.75 4.9v1c0 2.62 2.47 4.6 5.75 4.6s5.75-1.98 5.75-4.6v-1c0-1.28-.58-2.5-1.65-3.44-1.09-.94-2.54-1.46-4.1-1.46z"
        fill={props.color}
      />
    </Svg>
  );
